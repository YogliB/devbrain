...
export const suggestedQuestions = pgTable(
	...
	(table) => {
		return {
			...
			userSelectPolicy: pgPolicy(
				'suggested_questions_user_select_policy',
				{
					for: 'select',
					to: 'public',
			...
			userInsertPolicy: pgPolicy(
				'suggested_questions_user_insert_policy',
				{
					for: 'insert',
					to: 'public',
			...
			userUpdatePolicy: pgPolicy(
				'suggested_questions_user_update_policy',
				{
					for: 'update',
					to: 'public',
					using: sql`${table.userId} = current_setting('app.current_user_id', true)::text`,
			...
			userDeletePolicy: pgPolicy(
				'suggested_questions_user_delete_policy',
				{
					for: 'delete',
					to: 'public',
					using: sql`${table.userId} = current_setting('app.current_user_id', true)::text`,
